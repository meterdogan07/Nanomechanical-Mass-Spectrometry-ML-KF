...
model = Sequential()
model.add(layers.Conv1D(filters=16, kernel_size=5, padding="same", activation='relu', input_shape=(M,1)))
model.add(layers.Conv1D(filters=16, kernel_size=5, padding="same", activation='relu', input_shape=(M,1)))
...
# define the keras model
model2 = Sequential()
model2.add(layers.Conv1D(filters=16, kernel_size=5, padding="same", activation='relu', input_shape=(M,1)))
model2.add(layers.Conv1D(filters=16, kernel_size=5, padding="same", activation='relu', input_shape=(M,1)))
